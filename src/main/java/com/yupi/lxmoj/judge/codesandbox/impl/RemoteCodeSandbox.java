...
import com.yupi.lxmoj.utils.EncryptionUtils;
...
public class RemoteCodeSandbox implements CodeSandbox {
    ...
    public ExecuteCodeResponse executeCode(ExecuteCodeRequest executeCodeRequest) {
        ...
        // 加密密钥
        String encryptedSecret = EncryptionUtils.encrypt(AUTH_REQUEST_SECRET);

        String responseStr = HttpUtil.createPost(url)
                .header(AUTH_REQUEST_HEADER, encryptedSecret)
                .body(json)
                .execute()
                .body();
